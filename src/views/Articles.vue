      ...
      <div class="relative z-10 pb-8">
        ...
        <div class="flex gap-8 px-4">
          ...
          <div class="flex-shrink-0 flex items-center ml-4">
            <div class="bg-gradient-to-br from-slate-900/95 to-slate-800/95 dark:from-slate-900/95 dark:to-slate-800/95 backdrop-blur-sm rounded-2xl p-6 border border-amber-500/30 dark:border-amber-500/30 shadow-lg w-72">
              ...
              <div class="mb-6">
                ...
                <div class="relative">
                  ...
                  />
                  <button @click="performSearch" class="absolute right-3 top-1/2 transform -translate-y-1/2 text-slate-400 dark:text-slate-400 hover:text-amber-400 dark:hover:text-amber-400 transition-colors duration-300">
              ...
              <!-- Year Filter -->
              <div class="mb-6">
                <label class="block text-sm font-medium text-slate-200 dark:text-slate-200 mb-3">Publication Year</label>
                <select v-model="selectedYear" @change="loadArticles" class="w-full px-4 py-3 rounded-lg border border-amber-500/30 dark:border-amber-500/30 bg-slate-800/60 dark:bg-slate-800/60 text-white dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-400/50 focus:border-amber-400/50 transition-all duration-300 backdrop-blur-sm appearance-none cursor-pointer">
              ...
              <!-- Clear Filters -->
              <button @click="clearFilters" class="w-full px-4 py-3 bg-gradient-to-r from-amber-600/70 to-yellow-600/70 hover:from-amber-500/70 hover:to-yellow-500/70 text-white dark:text-white rounded-lg transition-all duration-300 border border-amber-500/50 hover:border-amber-400/50 backdrop-blur-sm font-medium">
                Clear Filters
              </button>
            </div>
          </div>
          ...
          <div class="flex-1 pt-20">
            ...
            <div v-else class="space-y-8 pt-4 max-w-4xl mx-auto">
              <article v-for="(article, index) in articles" :key="article.articleId"
                ...
                <!-- 顶部彩色横条 -->
                <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-amber-400 to-yellow-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
                  ...
                  <div class="flex justify-between items-center mt-3">
                    ...
                    <div class="flex items-center gap-4">
                      ...
                      <router-link :to="`/articles/${article.articleManuscriptId}`"
                        ...
                        Read Full Article
                        <svg class="w-5 h-5 ml-2 transition-transform duration-300 group-hover/link:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button @click="downloadArticle(article)"
                        ...
                        <span class="ml-1 hidden group-hover/download:inline transition-all duration-300">Download</span>
                      </button>
                    </div>
            ...
            <div v-if="!loading && articles.length === 0" class="text-center py-12">
              <div class="bg-gradient-to-br from-slate-900/95 to-slate-800/95 dark:from-slate-900/95 dark:to-slate-800/95 backdrop-blur-sm rounded-2xl p-8 border border-amber-500/30 dark:border-amber-500/30">
                ...
                <button @click="clearFilters" class="px-6 py-2 bg-gradient-to-r from-amber-600/70 to-yellow-600/70 hover:from-amber-500/70 hover:to-yellow-500/70 text-white rounded-lg transition-all duration-300 border border-amber-500/50 hover:border-amber-400/50 backdrop-blur-sm font-medium">
                  Clear Filters
                </button>
              </div>
            </div>
